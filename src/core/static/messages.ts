...
export const messages = {
  ...
  cyrillic_alpha_spaces: 'Поле может содержать только кириллицу пробел и цифры',
  ...
  min_length: 'Поле может содержать не менее {limit} файлов(а)',
  max_length: 'Поле может содержать не более {limit} файлов(а)',
  // max_size: "Максимальный общий размер файлов должен быть меньше, чем {size}KB",
}
